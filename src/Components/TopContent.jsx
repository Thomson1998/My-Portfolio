...
const profile = [
  ...
  return (
    <div name='home' className='min-h-screen flex flex-col justify-center items-center p-5 text-center bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <a href="https://drive.google.com/file/d/1qJccwCinGVZT7xIHoJ0aB16IYtA25GwT/view" target='_blank' rel='noopener noreferrer' className=' text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer hover:scale-110'>
            Resume
            <span> <IoIosEye /> </span>
        </a>
