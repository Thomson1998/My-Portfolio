...
const Icons = () => {
    ...
    const links = [
        ...
        },
        {
            ...
            href: 'https://drive.google.com/file/d/1qJccwCinGVZT7xIHoJ0aB16IYtA25GwT/view',
            style: 'rounded-br-md',
        }
    ]
    return (
        <div className='hidden lg:flex flex-col top-[35%] left-0 fixed'>
            <ul>
                ...
                {links.map(({id, child, href, style}) =>(
                     ...
                     <a href={href} className='flex justify-between items-center w-full text-white' target='_blank' rel='noopener noreferrer'>
                       {child}
                     </a>
                     </li>
                ))}
